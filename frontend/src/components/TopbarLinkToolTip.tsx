...
const TopbarLinkToolTip = ({
  ...
  return (
    <div className={`group relative ${className}`}>
      ...
      <div className="absolute left-1/2 top-8 -translate-x-1/2 text-nowrap rounded-md bg-primary-50 px-2 py-1 text-sm text-primary-200 opacity-0 shadow-lg duration-500 group-hover:opacity-100">
        {label}
      </div>
    </div>
  );
